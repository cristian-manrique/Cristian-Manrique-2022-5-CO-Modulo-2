...
from dino_runner.utils.constants import CLOUD, BG, ICON, SCREEN_HEIGHT, SCREEN_WIDTH, TITLE, FPS, DEFAULT_TYPE
...
class Game(Sprite):
    ...
    def __init__(self):
        ...
        self.background_image = pygame.display.set_mode((0, 300))
    ...
    def draw_background(self):
        ...
        self.background_image.blit(cloud_image, (40, 80))
    ...
    def draw_power_up_time(self):
        if self.player.has_power_up:
            ...
            if time_to_show >= 0:
                self.menu.draw(self.screen, f'{self.player.type.capitalize()} enabled for {time_to_show} seconds', 550,
                               110)
            else:
